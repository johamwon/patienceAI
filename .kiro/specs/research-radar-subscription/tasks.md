...
- [ ] 3. 新进展判定与去重（纯逻辑）
  ...
  - [ ] 3.2 fingerprint 属性测试 + is_new_progress 单元测试
...
- [ ] 9. 前端集成
  ...
  - [ ] 9.5 ExplanationView / SearchPage 集成 + 演示态触发
